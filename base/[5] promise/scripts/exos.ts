...
async function fetchPokemonData(name: string): Promise<Pokemon> {
    try {
...
function battlePokemon(pokemon1: Pokemon, pokemon2: Pokemon): number {
    let score1 = 0;
    let score2 = 0;
...
async function battleTeams(userTeam: Pokemon[], randomTeam: Pokemon[]): Promise<void> {
    let userWins = 0;
    let randomWins = 0;
