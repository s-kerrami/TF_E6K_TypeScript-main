...
const exos_3 = require("./models/exos");
// Création d'une personne
const personne = new exos_1.Personne();
personne.Nom = "Doe";
...
const courant = new exos_3.Courant();
...
const personne2 = new exos_1.Personne();
personne2.Nom = "Smith";
personne2.Prenom = "Jane";
personne2.DateNaiss = new Date("1985-02-15");
const courant2 = new exos_3.Courant();
...
const banque = new exos_2.Banque();
